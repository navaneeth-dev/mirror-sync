...
source_url='rsync://mirror.twds.com.tw/archlinux/'

# An HTTP(S) URL pointing to the 'lastupdate' file on your chosen mirror.
# If you are a tier 1 mirror use: https://rsync.archlinux.org/lastupdate
# Otherwise use the HTTP(S) URL from your chosen mirror.
lastupdate_url='https://mirror.twds.com.tw/archlinux/lastupdate'
...
rsync_cmd() {
	local -a cmd=(rsync -rptH -L --safe-links --delete-delay --delay-updates
		"--timeout=600" "--contimeout=60" --no-motd -v --progress)
